...
window.API = {
  ...
  pets: {
    ...
    updateVaccine:(petId, vaccineId, data) => apiFetch(`/pets/${petId}/vaccines/${vaccineId}`, { method: 'PUT', body: JSON.stringify(data) }),
    deleteVaccine:(petId, vaccineId) => apiFetch(`/pets/${petId}/vaccines/${vaccineId}`, { method: 'DELETE' }),
